...
def ranking_ledger(at: datetime) -> dict[str, object]:
    ...
    artifact: dict[str, object] = {
        ...
        "productMetricPolicyVersion": "product-metrics-2026-07-rc2.8",
        ...
        "leadCrossings": [
            {
                ...
                "policyVersion": "product-metrics-2026-07-rc2.8",
            }
            for rank in range(1, 36)
        ] + [
            {
    ...
    return {
        ...
        "responses": {
            "health": {
                ...
                "authRequired": True, "productionReady": True, "migrationVersion": "001_init_rc2.4",
